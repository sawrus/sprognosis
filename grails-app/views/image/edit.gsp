    ...
    <g:uploadForm method="post">
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="image.description.label"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="style"><g:message code="image.style.label"
                                                      default="Style"/> [height:10; width:10]</label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="fileName"><g:message code="image.fileName.label" default="File Name"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: imageInstance, field: 'fileName', 'errors')}">

                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="description" title="${message(code: 'image.fileName.label', default: 'File Name')}" />

                            <g:sortableColumn property="absolutePath" title="${message(code: 'image.webRootDir.label', default: 'Web Root Path')}" />

                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="postCategory" action="show" id="${postInstance?.category?.id}">${postInstance?.category?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="post.categoryVisible.label" default="Category Visible" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="post.mainPageVisible.label" default="Main Page Visible" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="post.twitterVisible.label" default="Twitter Visible" /></td>

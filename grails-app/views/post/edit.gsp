            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'content', 'errors')}">
                        <richui:richTextEditor name="content" id="content" value="${postInstance?.content}" width="640"
                                               height="480"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="announcement"><g:message code="post.announcement.label"
                                                             default="Announcement"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'announcement', 'errors')}">
                        <richui:richTextEditor name="announcement" id="announcement"
                                               value="${postInstance?.announcement}" width="640" height="360"/>
                    </td>
                </tr>

                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="description"><g:message code="post.description.label"
                                                            default="Description"/></label>
                    </td>
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'description', 'errors')}">
                        <richui:richTextEditor name="description" id="description" value="${postInstance?.description}"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="allowComments"><g:message code="post.allowComments.label"
                                                              default="Allow Comments"/></label>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'author', 'errors')}">
                        <g:select name="author.id" from="${com.sp.auth.User.list()}" optionKey="id"
                                  value="${postInstance?.author?.id}"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'category', 'errors')}">
                        <g:select name="category.id" from="${com.sp.site.PostCategory.list()}" optionKey="id"
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="categoryVisible"><g:message code="post.categoryVisible.label"
                                                                default="Category Visible"/></label>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'images', 'errors')}">
                        <g:select name="images" from="${com.sp.site.Image.list()}" multiple="yes" optionKey="id"
                                  size="5" value="${postInstance?.images*.id}"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'language', 'errors')}">
                        <g:select name="language" from="${com.sp.enums.Language?.values()}"
                                  keys="${com.sp.enums.Language?.values()*.name()}"
                                  value="${postInstance?.language?.name()}"/>
                    </td>
                </tr>

                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="mainPageVisible"><g:message code="post.mainPageVisible.label"
                                                                default="Main Page Visible"/></label>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="socialVisible"><g:message code="post.socialVisible.label"
                                                              default="Social Visible"/></label>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: postInstance, field: 'tags', 'errors')}">
                        <g:select name="tags" from="${com.sp.site.Tag.list()}" multiple="yes" optionKey="id" size="5"
                                  value="${postInstance?.tags*.id}"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="twitterVisible"><g:message code="post.twitterVisible.label"
                                                               default="Twitter Visible"/></label>
                    </td>

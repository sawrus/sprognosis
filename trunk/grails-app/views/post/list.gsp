        ...
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="announcement"
                                  title="${message(code: 'post.announcement.label', default: 'Announcement')}"/>

                <g:sortableColumn property="RSSVisible"
                                  title="${message(code: 'post.RSSVisible.label', default: 'RSSV isible')}"/>
